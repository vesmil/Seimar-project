...
namespace ViscaCommands
{
    ...
    namespace Focus
    {
        ...
        static constexpr byteArray<5> setFocusMode(FocusMode focus) { return {CTRL, 0x04, 0x38, focus, 0xFF}; }
    ...
    namespace Hdmi
    {
        ...
        static const std::array<std::pair<ViscaCommands::Hdmi::Format, QString>, FormatCount> FormatArray {
            std::pair<ViscaCommands::Hdmi::Format, QString>{ViscaCommands::Hdmi::Format::_3840x2160_29_97HZ, QString("3840x2160 29.97HZ")},
            std::pair<ViscaCommands::Hdmi::Format, QString>{ViscaCommands::Hdmi::Format::_3840x2160_25HZ, QString("3840x2160 25HZ")},
            std::pair<ViscaCommands::Hdmi::Format, QString>{ViscaCommands::Hdmi::Format::_1920x1080_59_94HZ, QString("1920x1080 59.94HZ")},
            std::pair<ViscaCommands::Hdmi::Format, QString>{ViscaCommands::Hdmi::Format::_1920x1080_29_97HZ, QString("1920x1080 29.97HZ")},
            std::pair<ViscaCommands::Hdmi::Format, QString>{ViscaCommands::Hdmi::Format::_1280x720_59_94HZ, QString("1280x720 59.94HZ")},
        };
